...
public final class NewsCurrentMainBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static NewsCurrentMainBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NewsCurrentMainBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.news_current_main, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NewsCurrentMainBinding bind(@NonNull View rootView) {
